...
def main():
    ...
    parser.add_argument('--noise_type', type=str, default='none', choices=['none', 'box'])
    ...
    logger.configure(dir=logger_dir, format_strs=['stdout', 'log', 'csv'] if MPI.COMM_WORLD.Get_rank() == 0 else [])
